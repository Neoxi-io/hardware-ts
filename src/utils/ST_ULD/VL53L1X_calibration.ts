...
import * as api from './VL53L1X_api'
import debugFactory from 'debug'

const debug = debugFactory('VL53L1X_calibration')

export const VL53L1_WrWord = async (dev: any, reg: any, value: any) => dev.writeReg16(reg, value)

export const VL53L1X_CalibrateOffset = async (dev: any, TargetDistInMm: any) => {
...
export const VL53L1X_CalibrateXtalk = async (dev: any, TargetDistInMm: any) => {
